...
Также доступны [сверка проектов с ТЗ и презентацией](СВЕРКА-ПРОЕКТОВ-С-ТЗ-И-ПРЕЗЕНТАЦИЕЙ.md) и [презентация для хакатона](presentations/Identity_and_Certificate_Radar_Hackathon.pptx).
